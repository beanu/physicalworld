...
public class RevoluteJointHelper implements Shape {
	...
	public RevoluteJointHelper(Box2dAdapter adapter) {
	...
	public void render(float delta) {
		if(data1!=null){
			...
			render.setColor(DebugColor.COLOR_RevoluteJoint);
